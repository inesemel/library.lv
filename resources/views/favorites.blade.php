        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg dark:bg-gray-900">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-300">
                    ...
                    <h3 class='font-semibold p-4'>{{__("messages.My_books")}}</h3>
                        ...
                        @foreach ($bookFavs as $bookFav)
                            <tr  class="border-b dark:border-neutral-500">
                                <td class="whitespace-nowrap px-6 py-4">
                                    <a href="{{action([App\Http\Controllers\BookController::class, 'details'],['id'=> $bookFav->book->id])}}">
                                        {{ $bookFav->book->title }}
                                    </a>
                                </td>

                                <td>
                                <form action="{{ route('books.delete_vote', $bookFav->book->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="group inline-flex items-center hover:text-gray-700 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-indigo-500">
                                        ...
                                        width="6mm"
                                        height="6mm"
                                        viewBox="0 0 10.975248 10.975249"
                                        version="1.1"
                                        id="svg5"
                                        ...
                                        xmlns:svg="http://www.w3.org/2000/svg">
                                            ...
                                            id="layer1"
                                            style="display:none"
                                            transform="translate(-43.288291,-196.92133)">
                                            <rect
                                        ...
                                        <g
                                            ...
                                            <path
                                            id="rect1154"
                                            style="fill:none;fill-opacity:1;stroke:#7e7e7e;stroke-width:0.731783;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1"
                                            d="m 45.886282,197.43878 -2.08054,2.08054 2.889659,2.88961 -2.889659,2.88966 2.08054,2.08054 2.889658,-2.88966 2.889612,2.88966 2.080539,-2.08054 -2.889611,-2.88961 2.889611,-2.88966 -2.080539,-2.08054 -2.889612,2.88961 z" />
                                        </g>
                                        </svg>
                                    </button>
                                </form>
