<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:border-gray-700 dark:text-gray-100 dark:bg-gray-900">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div>
                    <form action="{{ route('change-language') }}" method="post" class="p-4">
                        @csrf
                        <select name="locale" onchange="this.form.submit()" class="items-center px-6 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150 dark:bg-gray-800 dark:text-gray-400">
                            <option value="en" {{ App::getLocale() === 'en' ? 'selected' : '' }}>English</option>
                            <option value="lv" {{ App::getLocale() === 'lv' ? 'selected' : '' }}>Latviešu</option>
                        </select>
                    </form>
